...
export function Footer() {
  const socialLinks = [
    { icon: FaXTwitter, label: "X (Twitter)", href: "https://x.com/BecomeTheHive" },
    { icon: Send, label: "Telegram", href: "https://t.me/BecomeTheHive" },
        ...
        <div className="grid md:grid-cols-3 gap-12 md:gap-16 mb-16">
          ...
          >
            ...
            <p className="text-[#fafaf8]/80 text-base leading-relaxed">
              Building the future where gaming meets mining.
            </p>
          </motion.div>
