          ...
          {metrics.map((metric, index) => {
            ...
            return (
              <motion.div
                ...
                className="align-center p-6 rounded-3xl bg-white/10 backdrop-blur-md border border-white/20 hover:border-[#fafa5e]/60 shadow-xl hover:shadow-2xl transition-all duration-300"
              >
                {/* Hexagon Marker */}
                <Hexagon
