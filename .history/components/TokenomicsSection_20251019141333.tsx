...
export function TokenomicsSection() {
  const distribution = [
    ...
    { label: "Public", percentage: 28, color: "#fafa5e" },
    { label: "Grant", percentage: 8, color: "#473535" },
    { label: "Private Presale", percentage: 6, color: "#f38524" },
    { label: "Angel", percentage: 4, color: "#fafa5e" },
    { label: "Liquidity", percentage: 4, color: "#473535" },
  ];
