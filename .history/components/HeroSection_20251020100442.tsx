        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8 mt-20 max-w-5xl mx-auto">
          {floatingIcons.map(({ Icon, label, color, delay }, index) => (
            ...
            >
              ...
              <motion.div
                className="relative w-20 h-24 md:w-24 md:h-28 flex items-center justify-center"
                whileHover={{ rotate: 5 }}
                transition={{ duration: 0.3 }}
              >
                <div
                  className="hexagon absolute inset-0"
                  style={{
                    background: color,
                ...
                <Icon className="w-8 h-8 md:w-10 md:h-10 text-[#473535] relative z-10" />
              </motion.div>
