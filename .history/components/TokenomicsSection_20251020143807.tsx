        ...
        >
          <div className="inline-block px-8 py-4 rounded-2xl bg-white/10 backdrop-blur-md border border-[#fafa5e]/30">
            <p className="text-[#fafaf8]/90 text-lg">
              Launched on <span className="text-[#fafa5e] font-semibold">Ethereum</span> due to outstanding metrics, unless .
            </p>

            {/* More p info sections */}
            <p 
              className="text-[#fafaf8]/90 text-lg mt-4">
              Angel/Private Round will have chances to exit with Phase 2 being initiated. Angel Round will get 2x-10x dependent on time of entry and value of company
            </p>

            <p 
              className="text-[#fafaf8]/90 text-lg mt-4"
            >
              A deflationary model with periodic buybacks and burns ensures long-term value appreciation for token holders.
            </p>
          </div>
        </motion.div>
      </div>
