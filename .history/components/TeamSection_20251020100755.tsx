...
export function TeamSection() {
  const team = [
    ...
    },
    {
      name: "Carter Thuong",
      role: "Cofounder & CBDO",
      description: "Community builder, strategic connector.",
      color: "#fafa5e",
    },
    {
      name: "Speros (Strong)",
            ...
            >
              <div className="p-8 md:p-10 rounded-3xl bg-white/10 backdrop-blur-md border border-white/20 hover:border-[#fafa5e]/60 shadow-xl hover:shadow-2xl transition-all duration-300">
                ...
                <div className="relative mb-8">
                  <motion.div
                    className="relative w-28 h-32 mx-auto flex items-center justify-center"
                  ...
                  >
                    ...
                    <User className="w-14 h-14 text-[#473535] relative z-10" />
                  </motion.div>
