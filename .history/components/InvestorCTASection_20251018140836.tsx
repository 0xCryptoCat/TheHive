    ...
    <section className="py-20 md:py-32 bg-gradient-to-br from-[#473535] via-[#f38524] to-[#fafa5e] relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-20">
        <motion.div
          ...
          style={{
            backgroundImage: `url("data:image/svg+xml,%3Csvg width='100' height='100' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath d='M50 0L93.3 25v50L50 100 6.7 75V25z' fill='none' stroke='%23fafa5e' stroke-width='1'/%3E%3C/svg%3E")`,
      ...
      <div className="max-w-5xl mx-auto px-6 relative z-10 text-center">
        ...
        >
          ...
          >
            Join the Hive — Invest in the Future of Play & Power.
          </motion.h2>
          ...
          >
            Shape the Hive. Fuel the Future.
          </motion.p>
        </motion.div>
