  ...
  const metrics = [
    {
      ...
      icon: DollarSign,
      color: "#fafa5e",
      description: "Multiple streams of revenue while delivering value to users"
    },
    {
      title: "Pricing Strategy",
      icon: TrendingUp,
      color: "#f38524",
      description: "Tiered monthly or annual plans with varying levels of access and premium features"
    },
    {
      title: "Customer Acquisition",
      icon: Users,
      color: "#fafa5e",
      description: "Attract users with free access, convert through compelling premium offerings"
    },
    {
      title: "Mining Passive Returns",
      icon: Zap,
      color: "#f38524",
      description: "Compound revenue while maximizing returns from tokens"
    }
  ];

  const growthData = [
    { year: "2017", revenue: "$0.55" },
    { year: "2018", revenue: "$0.71" },
    { year: "2019", revenue: "$0.85" },
    { year: "2020", revenue: "$0.94" },
    { year: "2021", revenue: "$1.23" },
    { year: "2022", revenue: "$1.38" },
    { year: "2023", revenue: "$1.72" },
    { year: "2024", revenue: "$2.18" },
    { year: "2025", revenue: "$2.77" },
    { year: "2026", revenue: "$3.52" },
    { year: "2027", revenue: "$4.27" },
    { year: "2028", revenue: "$5.36" },
    { year: "2029", revenue: "$6.26" },
  ];
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        >
          <div className="bg-white/10 backdrop-blur-md rounded-3xl p-8 md:p-12 border border-[#fafa5e]/20">
            <h3 className="text-2xl md:text-3xl font-bold text-[#fafa5e] mb-6 text-center">
          ...
          {metrics.map((metric, index) => {
            ...
            return (
              ...
              >
                ...
                <h3 className="text-xl font-bold mb-3 text-[#fafa5e]">{metric.title}</h3>
