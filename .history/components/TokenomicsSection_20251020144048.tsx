  ...
  return (
    <section className="py-20 md:py-32 bg-[#473535] relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        >
          <div className="inline-block px-8 py-4 rounded-2xl bg-white/10 backdrop-blur-md border border-[#fafa5e]/30">
        ...
        >
          <div className="inline-block px-8 py-4 rounded-2xl bg-white/10 backdrop-blur-md border border-[#fafa5e]/30">
            <p 
              className="text-[#fafaf8]/90 text-lg mt-4" style={{ width: '50%' }}>
              Angel/Private Round participants will have opportunities to exit as Phase 2 is initiated. Returns for the Angel Round are projected between 2x and 10x, depending on the timing of entry and the company's valuation.
            </p>

            <p 
              className="text-[#fafaf8]/90 text-lg mt-4"
            >
              While the app is live, USDT will be distributed at a 40% revenue share rate until launch. Post-launch, this will decrease to 10% and reach 0% after 2 months.
            </p>
          </div>
        </motion.div>
      </div>
