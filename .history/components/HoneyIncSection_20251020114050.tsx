...
export function HoneyIncSection() {
  const steps = [
    { icon: Send, label: "Telegram", color: "linear-gradient(135deg, #fafa5e, #f38524)" },
    { icon: Smartphone, label: "App Stores", color: "linear-gradient(135deg, #f38524, #fafa5e)" },
    { icon: Award, label: "Rewards", color: "linear-gradient(135deg, #fafa5e, #f38524)" },
  ];
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        >
          ...
          <p className="text-lg text-[#fafaf8]/90 max-w-4xl mx-auto leading-relaxed">
            Honey, Inc. is more than just a newsletter — it's the onboarding bridge for the crypto-gaming world. Through our <span className="text-[#fafa5e]">"Refer"</span> & <span className="text-[#fafa5e]">"Earn"</span> model and gamified content, users get rewarded for engagement, learning, and sharing. With plans to launch on Telegram, iOS, and Google Play, our Honey, Inc. drives user acquisition and retention with performance metrics ranging from <span className="text-[#f38524]">2.00</span> to <span className="text-[#f38524]">450 RPM</span>.
          </p>
        </motion.div>
