...
export function HeroSection() {
  const floatingIcons = [
    ...
    { Icon: TrendingUp, label: "Earn", color: "#f38524", delay: 0.4 },
    { Icon: Users, label: "Grow", color: "#f36624ff", delay: 0.6 },
  ];
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-[#473535] via-[#f38524] to-[#fafa5e]">
      ...
      {/* Content Container */}
      <div className="relative z-10 max-w-8xl mx-auto px-6 py-20 text-center">
        <motion.div
        ...
        >
          <motion.h1 
            className="text-5xl md:text-7xl lg:text-8xl font-bold mt-10 mb-6 text-[#fafaf8] leading-tight"
          ...
          >
            ...
            >
              ...
              <motion.div
                animate={{
                  boxShadow: [
                    "0 0 40px 8px rgba(250, 250, 94, 0.4)",
                    "0 0 60px 12px rgba(250, 250, 94, 0.6)",
                    "0 0 40px 8px rgba(250, 250, 94, 0.4)",
                  ],
                }}
                transition={{
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8 mt-20 max-w-5xl mx-auto">
          {floatingIcons.map(({ Icon, label, color, delay }, index) => (
            ...
            >
              <Hexagon
                gradient="conic-gradient(from 0deg, #fafa5e, #f38524, #473535, #fafa5e)"
                size="sm"
                animate={true}
              ...
              >
                <Icon className="w-10 h-10 md:w-12 md:h-12 text-[#473535]" />
              </Hexagon>
