          ...
          <div className="p-8 rounded-3xl bg-gradient-to-br from-[#f38524]/20 to-[#fafa5e]/20 backdrop-blur-md border-2 border-[#f38524] shadow-xl">
            ...
            <ul className="space-y-3 text-[#fafaf8]/90">
              <li className="flex items-start gap-2">
                ...
                <span><span className="text-[#fafa5e] font-bold">BTC:</span> traditionally <span className="text-[#fafa5e] font-bold">30%-50%</span> APY, now <span className="text-[#fafa5e] font-bold">70%-90%</span></span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-[#fafa5e]">•</span>
                <span><span className="text-[#fafa5e] font-bold">Doge:</span> traditionally <span className="text-[#fafa5e] font-bold">70%-90%</span> APY, now <span className="text-[#fafa5e] font-bold">110%-130%</span></span>
              </li>
            </ul>
          </div>
        </motion.div>
