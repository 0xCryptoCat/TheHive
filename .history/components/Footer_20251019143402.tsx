        ...
        <div className="grid md:grid-cols-3 gap-12 md:gap-16 mb-16">
          ...
          >
            ...
            <div className="space-y-4">
              <motion.a
                href="tel:+6282145572180"
                whileHover={{ x: 5 }}
                className="flex items-center gap-3 text-[#fafaf8]/80 hover:text-[#fafa5e] transition-colors group"
              >
                <div className="w-10 h-10 rounded-lg bg-white/10 flex items-center justify-center group-hover:bg-[#fafa5e]/20 transition-colors">
                  <Phone className="w-5 h-5" />
                </div>
                <span>+62 821-4557-2180</span>
              </motion.a>
              <motion.a
              ...
              >
                ...
                <span>BecomeTheHive@gmail.com</span>
              </motion.a>
            </div>
          </motion.div>
