    ...
    <section className="py-24 bg-[#473535] relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-10">
        <div className="absolute inset-0" style={{
          backgroundImage: `url("data:image/svg+xml,%3Csvg width='60' height='60' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath d='M30 0L51.96 15v30L30 60 8.04 45V15z' fill='none' stroke='%23fafa5e' stroke-width='1'/%3E%3C/svg%3E")`,
