      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <p className="text-lg md:text-xl text-[#2d2d2d]/80 max-w-4xl mx-auto leading-relaxed mb-4">
            The Hive redefines the boundaries between gaming and blockchain. By converting natural gas runoffs into clean, low-cost mining energy, we transform waste into opportunity. Every player, miner, and investor becomes a part of one collective ecosystem — <span className="text-[#f38524] font-semibold">The Hive Mind.</span>
          </p>
        ...
        {/* Highlights Grid - 1x6 mobile, 2x3 tablet, 3x2 desktop */}
