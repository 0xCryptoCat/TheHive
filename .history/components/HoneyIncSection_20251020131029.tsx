...
export function HoneyIncSection() {
  const steps = [
    ...
    { icon: Smartphone, label: "App Stores", color: "#f38524" },
    { icon: Award, label: "Rewards", color: "#f36924ff" },
  ];
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        >
          <blockquote className="text-2xl md:text-3xl text-center text-[#fafa5e] italic relative">
            ...
            Give a bee some pollen and it'll eat for a day. Teach a bee to pollinate, and it'll feed the whole Hive.
