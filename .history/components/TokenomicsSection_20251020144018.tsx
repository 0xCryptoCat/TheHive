        ...
        >
          <div className="inline-block px-8 py-4 rounded-2xl bg-white/10 backdrop-blur-md border border-[#fafa5e]/30">
            <p 
              ...
              Angel/Private Round participants will have opportunities to exit as Phase 2 is initiated. <br /> Returns for the Angel Round are projected between 2x and 10x, depending on the timing of entry and the company's valuation.
            </p>
