    ...
    <section className="py-20 md:py-32 bg-gradient-to-b from-[#2d2d2d] to-[#473535] relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          {metrics.map((metric, index) => {
            ...
            return (
              <motion.div
                ...
                className="text-center p-6 rounded-3xl bg-white/10 backdrop-blur-md border border-white/20 hover:border-[#fafa5e]/60 shadow-xl hover:shadow-2xl transition-all duration-300"
        ...
        <motion.div
          ...
          className=""
        >
          <div className="grid md:grid-cols-2 gap-6 p-8 rounded-3xl bg-gradient-to-br from-[#f38524]/20 to-[#fafa5e]/20 backdrop-blur-md border-2 border-[#f38524] shadow-xl">
              <div>  
                <h3 className="text-2xl font-bold mb-6 text-[#f38524]">Mining Returns</h3>
                <ul className="space-y-3 text-[#fafaf8]/90">
                <li className="flex items-start gap-2">
                    <span className="text-[#fafa5e]">•</span>
                    <span><span className="font-bold">BTC:</span> traditionally <span className="text-[#fafa5e] font-bold">30%-50%</span> APY, now <span className="text-[#f38524] font-bold">70%-90%</span></span>
                </li>
                <li className="flex items-start gap-2">
                    <span className="text-[#fafa5e]">•</span>
                    <span><span className="font-bold">Doge:</span> traditionally <span className="text-[#fafa5e] font-bold">70%-90%</span> APY, now <span className="text-[#f38524] font-bold">110%-130%</span></span>
                </li>
                </ul>
              </div>  
              <div >
                <h3 className="text-2xl font-bold mb-6 text-[#f38524]">User Growth</h3>
                <ul className="space-y-3 text-[#fafaf8]/90">
                  <li className="flex items-start gap-2">
                    <span className="text-[#fafa5e]">•</span>
                    <span>Projected to reach <span className="text-[#fafa5e] font-bold">500,000</span> active users by end of 2024.</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-[#fafa5e]">•</span>
                    <span>Monthly active users growing at a rate of <span className="text-[#fafa5e] font-bold">15%</span> month-over-month.</span>
                  </li>
                </ul>
              </div>
          </div>
