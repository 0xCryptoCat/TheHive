    ...
    <section className="py-20 md:py-32 bg-gradient-to-b from-[#2d2d2d] to-[#473535] relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <motion.div
          ...
          className=""
        >
          <div className="grid md:grid-cols-2 gap-8 p-8 rounded-3xl bg-gradient-to-br from-[#f38524]/20 to-[#fafa5e]/20 backdrop-blur-md border-2 border-[#f38524] shadow-xl">
              <div>  
