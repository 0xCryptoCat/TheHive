  ...
  return (
    <section className="py-24 bg-gradient-to-br from-[#fafa5e]/20 via-[#fafaf8] to-[#f38524]/20">
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          <p className="text-lg md:text-xl text-[#2d2d2d]/80 max-w-3xl mx-auto leading-relaxed mb-6">
            By integrating gaming, mining, and learning into a single adaptive platform, The Hive is set to capture a significant share of this booming market.
          </p>
          {/* Learn More button to Socials */}
          <a
            href="#"
            className="inline-block px-8 py-4 rounded-full bg-gradient-to-r from-[#fafa5e] to-[#f38524] text-[#473535] font-bold text-lg shadow-2xl hover:shadow-[#fafa5e]/60 transition-all duration-300 border-2 border-[#fafa5e]/50 hover:border-[#fafa5e]/70"
          >
            Learn More
          </a>
        </motion.div>
